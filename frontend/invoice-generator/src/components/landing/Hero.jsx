      ...
      <section className="relative bg-[#fbfbfb] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="select-none text-4xl sm:text-5xl lg:text-6xl font-extrabold text-orange-500 leading-tight">
              <span className="text-slate-700">Intelligent</span> AI Powered
              Invoicing, Made Effortless
            </h1>
            <p className="select-none text-xl sm:text-xl text-gray-700 mb-8 leading-relaxed max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              {isAuthenticated ? (
                <Link
                  to={"/dashboard"}
                  className="bg-linear-to-r border-2 border-orange-500 from-orange-500 to-orange-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-orange-500 transition-all duration-200 hover:scale-105 hover:shadow-2xl transform"
                >
                  Go to Dashboard
                </Link>
              ) : (
